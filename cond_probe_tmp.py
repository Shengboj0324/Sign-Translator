...
rec.eval()
for cond in [Condition("clean"),Condition("noisy",noise=0.04),Condition("noisy2",noise=0.06),
             Condition("accented",pitch_scale=1.08),Condition("accented2",pitch_scale=1.15),
             Condition("code_switched",vocabulary="mixed"),Condition("long_form",words=8)]:
