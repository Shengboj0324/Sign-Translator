...
for bw,brw,name in [(0.0,0.0,'ASR only'),(0.5,0.0,'+boundary'),(0.0,0.3,'+brier'),(0.5,0.3,'full')]:
    rec,head,obj,fe=train(bw,brw)
    f1,ece=evaluate(rec,head,fe)
    print(f'{name:12s} boundaryF1={f1:.3f}  ECE={ece:.4f}')
