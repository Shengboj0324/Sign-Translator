...
| 10 | **Data engineering** | `data_engineering/` | Canonical sample schema; evidence-backed, action-scoped authorization *before* download; distinct direct-consent and published-license paths; a Merkle-style **provenance chain**; multi-view **DLT triangulation** with confidence propagation; leakage-certified grouped split; a sensitive-trait non-inference guard; datasheets. |
